...
class BaseNavigationController: UINavigationController {
    ...
    func reloadNavigationBar(){
        ...
        //设置标题颜色
        let navigationTitleAttribute = NSDictionary(object: UIColor.black, forKey: NSAttributedString.Key.foregroundColor as NSCopying)
